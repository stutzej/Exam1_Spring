...
Authors: Every CSSE faculty member, Dr. Brackin, and Liz Stutz.
"""
    ...
    def go_to_floor(self,floor):
        ...
        for k in range(self.num_floors):
            ...
            if floor < self.num_floors:
                self.current_floor = self.current_floor + floor
                return True
            else:
                self.current_floor = 0
                return  False
...
# ---------------------------------------------------------------------
# ---------------------------------------------------------------------
    def passengers_exiting(self, num_passengers, passengers_leaving):
        for k in range(num_passengers):
            if passengers_leaving <= num_passengers:
                self.current_passengers = num_passengers - passengers_leaving
...
def run_test_go_to_floor():
    ...
    # Test 2:  Sends elevator to 13th floor.
    e2 = Elevator(20, 18)
    expected_capacity = 20
    expected_num_floors = 18
    expected_go_to_floor = 13
    print('Expected: go_to_floor returns :', True)
    print("Expected:", expected_capacity, expected_num_floors, expected_go_to_floor)
    print('Actual: go_to_floor returns: ', e2.go_to_floor(13))
    print('Actual: ', e2.capacity, e2.num_floors, e2.current_floor)

    # Test 3:  Sends elevator to 10th floor.
    e3 = Elevator(20, 9)
    expected_capacity = 20
    ...
    print("Expected:", expected_capacity, expected_num_floors, expected_go_to_floor)
    print('Actual: go_to_floor returns: ', e3.go_to_floor(11))
...
def run_test_get_passengers():
    ...
    #Test 2: Adds 14 passengers to an empty elevator.
    e1 = Elevator(13, 18)
    ...
    print("Expected:", expected_capacity, expected_num_floors, expected_num_passengers)
    print("Actual:  ", e1.get_passengers(14))
    print("Actual: ", e1.capacity, e1.num_floors, e1.current_passengers)

def run_test_passengers_exiting():
    e1 = Elevator(13, 18)
    expected_capacity = 13
    expected_num_floors = 18
    expected_num_passengers = 8
    print("Expected:", expected_capacity, expected_num_floors, expected_num_passengers)
    print("Actual: ", e1.capacity, e1.num_floors, e1.passengers_exiting(13, 5))
